...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (registerUser.fulfilled.match(result)) {
      dispatch(addToast(`Welcome to Expense Tracker, ${result.payload.user.name}!`, 'success'));
      navigate('/app', { replace: true });
    }
  };
        ...
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl border border-gray-200/80 dark:border-gray-800/80 p-8 sm:p-10 shadow-2xl shadow-indigo-500/10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              Start tracking and syncing your expenses in MongoDB
            </p>
          </div>
          ...
          {authError && (
            ...
            >
              ...
              <div>
                <p className="font-semibold text-xs uppercase tracking-wider text-rose-800 dark:text-rose-200">Registration Failed</p>
